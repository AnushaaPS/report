...
with st.form("project_form"):
    ...
    student_1 = st.text_input("Student 1 Name [in CAPITAL LETTERS & initial at last, eg. ANUSHAA P S]", "")
    reg_no_1 = st.text_input("Register Number 1 [in brackets, eg. (92042210XXXX)]", "")
    student_2 = st.text_input("Student 2 Name [(Optional) initial at last, eg. ANUSHAA P S]", "")
    reg_no_2 = st.text_input("Register Number 2 [Optional in brackets, eg. (92042210XXXX)]", "")
    student_3 = st.text_input("Student 3 Name [(Optional) initial at last, eg. ANUSHAA P S]", "")
    reg_no_3 = st.text_input("Register Number 3 [Optional in brackets, eg. (92042210XXXX)]", "")
    student_4 = st.text_input("Student 4 Name [(Optional) initial at last, eg. ANUSHAA P S]", "")
    ...
    if project_type == "External Project":
        ...
        industry_person_name = st.text_input("Industry Person Name [eg. Mr. S. Kumar]", "")
